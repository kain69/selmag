...
import ru.karmazin.manager.controller.payload.UpdateProductPayload;
import ru.karmazin.manager.entity.Product;
import ru.karmazin.manager.service.ProductService;
...
public class ProductController {
    ...
    public String handleNoSuchElementException(NoSuchElementException e, Model model, HttpServletResponse response,
        ...
        model.addAttribute("error", this.messageSource.getMessage(e.getMessage(), new Object[0],
            e.getMessage(), locale));
        return "errors/404";
    }
}
