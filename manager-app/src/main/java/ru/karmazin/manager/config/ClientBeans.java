package ru.karmazin.manager.config;
...
import ru.karmazin.manager.client.RestClientProductsRestClient;
import ru.karmazin.manager.security.OAuthClientHttpRequestInterceptor;
